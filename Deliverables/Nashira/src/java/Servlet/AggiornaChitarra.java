 ...
 * @author LittleJoke
 */
@WebServlet("/AggiornaChitarra")
public class AggiornaChitarra extends HttpServlet {

    public AggiornaChitarra() {
        super();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String ids = (String) request.getParameter("idchitnew");
        String qntnew = (String) request.getParameter("qntnew");
        int id = Integer.parseInt(ids);
        int qntn = Integer.parseInt(qntnew);
        try {
            c = cdao.getByID(id);
            c.setQnt(qntn);
            cdao.update(c);
